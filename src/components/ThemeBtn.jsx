  ...
  return (
    <div>
      ...
      <button
        ...
        className={`inline-flex items-center px-4 py-2 transition-colors duration-200 w-9 h-9 justify-center text-xs font-medium text-gray-700 bg-white border border-gray-200 rounded-lg toggle-dark-state-example hover:bg-gray-100 dark:hover:text-blue-700 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-gray-300 dark:focus:ring-gray-500 dark:bg-gray-800 focus:outline-none dark:text-gray-400 dark:border-gray-600 dark:hover:bg-gray-700`}
      >
        {themeMode === "light" ? (
          <div>
            <svg
